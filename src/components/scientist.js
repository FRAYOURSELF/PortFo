...
textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
  ...
  return (
    <div className="scientist">
        <div className="science"><h1>Am I a</h1></div>
        <div className="text-stylee"><h1>I am an <b>Artist</b> and I create <b>Art</b></h1></div>
        <div className="txtt"><h1 class="ml1">
        <span class="text-wrapper">
            <span class="line line1"></span>
            <span class="letters">Scientist??</span>
